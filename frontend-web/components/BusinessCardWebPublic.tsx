...
type Props = {
  card: CardData;
  theme: CardTheme;
  /** `card-social://business/{bId}?uid=...&mode=permanent` */
  appDeepLink: string;
  locale?: 'es' | 'en';
};

export default function BusinessCardWebPublic({ card, theme, appDeepLink, locale = 'es' }: Props) {
  ...
  return (
    <div style={{ width: '100%', maxWidth: 420, margin: '0 auto' }}>
      ...
      <PublicLegalFooter locale={locale} accentColor={bd.color} background={`${bd.color}14`} />
    </div>
  );
}
