      ...
      <label className="grid gap-2">
        ...
        <div className="grid gap-3 sm:grid-cols-[150px_1fr]">
          <select
            ...
            className="min-h-14 rounded-2xl border border-white/10 bg-[#050505]/70 px-4 text-white outline-none transition focus:border-[#D4AF37]/70 focus:ring-4 focus:ring-[#D4AF37]/10"
          >
      ...
      <main className="relative">
        ...
        <nav className="fixed left-0 right-0 top-0 z-40 border-b border-white/10 bg-[#050505]/72 backdrop-blur-2xl">
          <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-6 sm:px-8 lg:px-10">
            ...
            <div className="flex items-center gap-3">
              <a href="#waitlist" className="hidden rounded-full border border-[#D4AF37]/35 bg-[#D4AF37]/10 px-4 py-2 text-xs font-black uppercase tracking-[0.16em] text-[#F6DA87] sm:inline-flex">
                {c.navCta}
              </a>
              <a
                href={c.switchHref}
        ...
        <section className="mx-auto grid w-full max-w-7xl gap-10 px-6 py-24 sm:px-8 lg:grid-cols-[0.9fr_1.1fr] lg:px-10">
          <Reveal className="flex flex-col justify-center">
            <p className="text-xs font-black uppercase tracking-[0.28em] text-[#D4AF37]">{c.vaultKicker}</p>
          ...
          <motion.div variants={stagger} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.18 }} className="grid gap-4 sm:grid-cols-2">
            {c.iconoDatas.map(([title, text, icon], index) => (
              ...
              >
                <div className="mb-5 grid h-12 min-w-12 place-items-center rounded-2xl border border-[#D4AF37]/30 bg-[#D4AF37]/10 px-3 text-xs font-black text-[#F6DA87] shadow-[0_0_28px_rgba(212,175,55,0.14)]">
                  {icon}
                </div>
          ...
          <Reveal>
            <div className="relative overflow-hidden rounded-[2.4rem] border border-[#D4AF37]/30 bg-[#0A0A0A]/82 p-6 shadow-[0_0_110px_rgba(212,175,55,0.16),0_34px_120px_rgba(0,0,0,0.58)] backdrop-blur-2xl sm:p-10 lg:p-12">
              ...
              <div className="relative grid gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
                <div>
                  <p className="text-xs font-black uppercase tracking-[0.28em] text-[#D4AF37]">{c.privateCallKicker}</p>
                  ...
                  <div className="relative rounded-[2.6rem] border border-white/15 bg-[#050505] p-4 shadow-[0_0_90px_rgba(212,175,55,0.18),0_26px_90px_rgba(0,0,0,0.66)]">
                    <div className="overflow-hidden rounded-[2rem] border border-white/10 bg-[linear-gradient(180deg,#111111,#050505)] p-6">
                      ...
                      <div className="mt-12 grid grid-cols-2 gap-4">
                        ...
                        <button type="button" className="min-h-14 rounded-2xl border border-[#D4AF37]/35 bg-[#D4AF37]/18 text-sm font-black uppercase tracking-[0.16em] text-[#F6DA87] shadow-[0_0_28px_rgba(212,175,55,0.18)]">
                          {c.answer}
                        </button>
                      </div>
                    </div>
        ...
        <section className="mx-auto w-full max-w-7xl px-6 py-24 sm:px-8 lg:px-10">
          <Reveal className="mx-auto max-w-3xl text-center">
            <p className="text-xs font-black uppercase tracking-[0.28em] text-[#D4AF37]">{c.architectureKicker}</p>
        ...
        <section className="mx-auto w-full max-w-5xl px-6 py-24 text-center sm:px-8 lg:px-10">
          <Reveal>
            <div className="mx-auto mb-8 grid h-16 w-16 place-items-center rounded-full border border-[#D4AF37]/40 bg-[#D4AF37]/12 text-lg font-black text-[#F6DA87] shadow-[0_0_42px_rgba(212,175,55,0.24)]">
              CS
            </div>
        ...
        <section className="mx-auto w-full max-w-7xl px-6 py-24 sm:px-8 lg:px-10">
          <Reveal className="mx-auto max-w-4xl text-center">
            <p className="text-xs font-black uppercase tracking-[0.28em] text-[#D4AF37]">{c.marketKicker}</p>
        ...
        <section className="mx-auto w-full max-w-7xl px-6 py-24 sm:px-8 lg:px-10">
          <Reveal className="mx-auto max-w-3xl text-center">
            <p className="text-xs font-black uppercase tracking-[0.28em] text-[#D4AF37]">{c.tiersKicker}</p>
          ...
          <Reveal>
            <div className="relative overflow-hidden rounded-[2.4rem] border border-[#D4AF37]/30 bg-[#0A0A0A]/82 p-6 shadow-[0_0_100px_rgba(212,175,55,0.12),0_34px_120px_rgba(0,0,0,0.58)] backdrop-blur-2xl sm:p-10 lg:p-12">
              ...
              <div className="relative grid gap-8 lg:grid-cols-[0.88fr_1.12fr] lg:items-center">
                <div>
                  <p className="text-xs font-black uppercase tracking-[0.28em] text-[#D4AF37]">{c.dashboardKicker}</p>
