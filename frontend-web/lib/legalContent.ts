/**
 * Mismo contenido que el menú legal de la app (`app/(tabs)/_layout.tsx`).
 * Mantener sincronizado si cambias el copy en la app.
 */
...
export const PRIVACY_PARAGRAPH_ES =
...
export const PRIVACY_PARAGRAPH_EN =
