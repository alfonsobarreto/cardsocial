/**
 * Themes sincronizados 1:1 con constants/themeChest.ts de la app nativa.
 * NO modificar aquí sin modificar también themeChest.ts — son la misma fuente de verdad.
 */
