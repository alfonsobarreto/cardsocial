      ...
      <ScrollView style={styles.content} {...verticalScrollInteractionProps} contentContainerStyle={[SCROLL_CONTENT_MIN_FILL, styles.contentPad]} showsVerticalScrollIndicator={false}>
        ...
        <View style={[styles.card, styles.dangerCard]}>
          ...
          <View style={styles.dangerLinks}>
            <View style={styles.dangerLink}>
              <MaterialCommunityIcons name="firebase" size={16} color="#E74C3C" />
              <Text style={styles.dangerLinkText}>{tr('Consola Firebase', 'Firebase Console')}</Text>
              <MaterialCommunityIcons name="open-in-new" size={13} color="#E74C3C" />
            </View>
            <View style={styles.dangerLink}>
              <MaterialCommunityIcons name="microsoft-azure" size={16} color="#E74C3C" />
              <Text style={styles.dangerLinkText}>{tr('Azure Portal', 'Azure Portal')}</Text>
              <MaterialCommunityIcons name="open-in-new" size={13} color="#E74C3C" />
            </View>
            <View style={styles.dangerLink}>
              <MaterialCommunityIcons name="cellphone-arrow-down" size={16} color="#E74C3C" />
              <Text style={styles.dangerLinkText}>{tr('Expo Dashboard', 'Expo Dashboard')}</Text>
              <MaterialCommunityIcons name="open-in-new" size={13} color="#E74C3C" />
            </View>
          </View>
        </View>
