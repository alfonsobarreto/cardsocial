/**
 * Precio anual derivado del mensual + % de descuento publicado en `system_config/tiers`.
 */
...
export type TierAnnualPricingInput = {
  ...
  /** Legacy / inferencia al migrar docs viejos. */
...
export type TierAnnualPricingDerived = {
  ...
  /** Legacy: espejo de `annualTrialDays` para lectores antiguos. */
  freeTrialDays: 0 | 15;
};
...
/** Equivalente mensual efectivo del plan anual (precio anual / 12). */
